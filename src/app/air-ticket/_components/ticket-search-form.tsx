...
const TicketSearchForm = ({
  ...
  return (
    <>
      {!showInnerButton && (
        <header
          className={`mb-9 flex justify-center gap-0 text-center text-28 font-bold`}
        >
          항공권
          <img
            src="/icons/plane.svg"
      ...
      <form
        className="mx-9 mb-6 grid min-w-[952px] grid-cols-[2fr_1fr_3fr] gap-4 bg-gray-50 p-4 px-9 py-8 shadow-md"
      ...
      >
        ...
        <div className="flex flex-col items-start gap-2">
          ...
          <div className="flex gap-8">
            ...
            <Button
              type="submit"
              className={`h-11 w-24 !rounded-12 py-[10px] text-white ${
                showInnerButton
